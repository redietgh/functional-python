# Functional Python [![](https://github.com/redietgh/functional-python/workflows/tests/badge.svg)](https://github.com/redietgh/functional-python/actions?query=workflow%3Atests)
